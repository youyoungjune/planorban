      ...
      <div className="flex justify-center p-4 gap-x-4">
        ...
        <div className="xl:w-175 px-8 2xl:p-0">
          ...
          <p>
            ...
            Meeting with parents after they and I both get off work, homework help,
            afterschool programs, etc; all of it is needed. In addition, I would
            still sharpen my technical skills after the school day by
            ...
            frustration because students are not progressing at the pace that they
            need to or the ever-increasing sense of urgency that arises when working in an area with high concentrations of poverty and violence—all the
